...
export function createProjectLegacySource(ctx: ModuleContext): ProjectSource {
	...
	return {
		...
		listAttachments: svc.listAttachments.bind(svc),
		addAttachment: svc.addAttachment.bind(svc),
		removeAttachment: svc.removeAttachment.bind(svc),
		clearLegacyAttachment: svc.clearLegacyAttachment.bind(svc),
