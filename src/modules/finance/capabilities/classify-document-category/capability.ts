...
function buildSystemPrompt(): string {
	...
	return [
		...
		'- INVOICE — the title says "Invoice" / "Commercial Invoice" / "Tax Invoice",',
		'  it has an invoice number, line items, and a payable TOTAL / "Amount',
		'  Chargeable". This is an invoice EVEN IF it also describes shipping,',
		'  freight, ports, customs, or "free samples / no commercial value".',
		'  Shipping and customs wording does NOT make it a logistics document.',
