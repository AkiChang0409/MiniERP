...
function buildVendorInvoiceIntake(deps: FinanceWorkflowDeps): WorkflowDefinition {
	return {
		...
		applyStepResult({ targetStep, payload, outputs }: ApplyStepResultArgs): ApplyStepResult {
